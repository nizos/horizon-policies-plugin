...
htmlhelp_basename = 'Policy-UIdoc'
...
man_pages = [
    ('index', u'Policy UI Documentation',
     'Documentation for the Policy UI plugin to the Openstack\
      Dashboard (Horizon)',
     [u'OpenStack'], 1)
]
...
texinfo_documents = [
    ('index', 'Policy UI',
     u'Policy UI Documentation', u'OpenStack',
     'Policy UI',
     'Policy User Interface', 'Miscellaneous'),
]
...
epub_title = u'Policy UI'
epub_author = u'OpenStack'
epub_publisher = u'OpenStack'
epub_copyright = u'2020, OpenStack'
