...
identity_docs = {
    ...
    "identity:get_auth_projects": {
        ...
        "description": "List all projects a user has access"
    ...
    "identity:get_auth_domains": {
        ...
        "description": "List all domains a user has access"
        " to via role assignments."
    },
    "identity:get_auth_system": {
        ...
        "description": "List systems a user has access to"
    ...
    "identity:get_domain_config": {
        ...
        "description": "Get the entire domain configuration for a domain,"
        " an option group within a domain, or a specific configuration"
        " option within a group for a domain."
    },
    ...
    "identity:get_domain_config_default": {
        ...
        "description": "Get domain configuration default for either"
        " a domain, specific group or a specific option in a group."
    },
    ...
    "identity:list_projects_associated_with_endpoint_group": {
        ...
        "description": "List all projects associated with a specific"
        " endpoint group."
    },
    ...
    "identity:get_endpoint_group_in_project": {
        ...
        "operations": [
            ...
            "HEAD /v3/OS-EP-FILTER/endpoint_groups/"
            "{endpoint_group_id}/projects/{project_id}"
        ],
        "description": "Check if an endpoint group is"
    ...
    "identity:list_endpoint_groups_for_project": {
        ...
        "description": "List endpoint groups associated"
    ...
    "identity:add_endpoint_group_to_project": {
        ...
        "operations": [
            "PUT /v3/OS-EP-FILTER/endpoint_groups/"
            "{endpoint_group_id}/projects/{project_id}"
        ],
    ...
    "identity:check_grant": {
        ...
        "operations": [
            ...
            "roles/{role_id}/inherited_to_projects",
            "HEAD /v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/"
            "roles/{role_id}/inherited_to_projects",
            "GET /v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/"
            "roles/{role_id}/inherited_to_projects",
        ...
        " where grants on the target are inherited to all"
    ...
    "identity:list_grants": {
        ...
        " A target can be either a domain or a project."
        " An actor can be either a user or a group."
        " For the OS-INHERIT APIs, it is possible to list"
        " inherited role grants for actors on domains,"
        " where grants are inherited to all projects"
    ...
    "identity:create_grant": {
        ...
        "operations": [
            ...
            "PUT /v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/roles/"
            "{role_id}/inherited_to_projects",
            "PUT /v3/OS-INHERIT/domains/{domain_id}/users/{user_id}/roles/"
            "{role_id}/inherited_to_projects",
            "PUT /v3/OS-INHERIT/domains/{domain_id}/groups/{group_id}/roles/"
            "{role_id}/inherited_to_projects"
        ],
        "description": "Create a role grant between a target and an actor."
        " A target can be either a domain or a project."
        " An actor can be either a user or a group."
        " These terms also apply to the OS-INHERIT APIs,"
        " where grants on the target are inherited to"
        " all projects in the subtree, if applicable."
    },
    "identity:revoke_grant": {
        ...
        "operations": [
            ...
            "roles/{role_id}",
            "DELETE /v3/projects/{project_id}/groups/{group_id}/"
            "roles/{role_id}",
            "DELETE /v3/domains/{domain_id}/users/{user_id}/"
            "roles/{role_id}",
            "DELETE /v3/domains/{domain_id}/groups/{group_id}/"
            "roles/{role_id}",
            "DELETE /v3/OS-INHERIT/projects/{project_id}/users/{user_id}/"
            "roles/{role_id}/inherited_to_projects",
            "DELETE /v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/"
            "roles/{role_id}/inherited_to_projects",
            "DELETE /v3/OS-INHERIT/domains/{domain_id}/users/{user_id}/"
            "roles/{role_id}/inherited_to_projects",
            "DELETE /v3/OS-INHERIT/domains/{domain_id}/groups/{group_id}/"
            "roles/{role_id}/inherited_to_projects"
        ],
        "description": "Revoke a role grant between a target and an actor."
        " A target can be either a domain or a project. An actor can be"
        " either a user or a group. These terms also apply to the"
        " OS-INHERIT APIs, where grants on the target are inherited to"
        " all projects in the subtree, if applicable. In that case,"
        " revoking the role grant in the target would remove the"
        " logical effect of inheriting it to the target's projects subtree."
    },
    ...
    "identity:get_implied_role": {
        ...
        "description": "Get information about an association between"
        " two roles."
        " When a relationship exists between a prior role and an implied"
        " role and the prior role is assigned to a user,"
    ...
    "identity:list_implied_roles": {
        ...
        "description": "List associations between two roles."
        " When a relationship exists between a prior role and"
        " an implied role and the prior role is assigned to a user,"
        " the user also assumes the implied role."
        " This will return all the implied roles that would"
        " be assumed by the user who gets the specified prior role."
    },
    "identity:create_implied_role": {
        ...
        "description": "Create an association between two roles."
    ...
    "identity:delete_implied_role": {
        ...
        "description": "Delete the association between two roles."
        " When a relationship exists between a prior role"
        " and an implied role and the prior role is assigned"
        " to a user, the user also assumes the implied role."
        " Removing the association will cause that effect"
        " to be eliminated."
    },
    "identity:list_role_inference_rules": {
        ...
        " When a relationship exists between a prior role and an implied role"
        " and the prior role is assigned to a user,"
        " the user also assumes the implied role."
    },
    "identity:check_implied_role": {
        ...
        "description": "Check an association between two roles."
        " When a relationship exists between a prior role"
        " and an implied role and the prior role is assigned to"
        " a user, the user also assumes the implied role."
    },
    ...
    "identity:create_mapping": {
        ...
        "description": "Create a new federated mapping"
        " containing one or more sets of rules."
    },
    ...
    "identity:check_policy_association_for_endpoint": {
        ...
        "operations": [
            ...
            "{endpoint_id}",
            "HEAD /v3/policies/{policy_id}/OS-ENDPOINT-POLICY/endpoints/"
            "{endpoint_id}"
        ],
    ...
    "identity:delete_policy_association_for_endpoint": {
        ...
        "operations": [
            "DELETE /v3/policies/{policy_id}/OS-ENDPOINT-POLICY/endpoints/"
            "{endpoint_id}"
        ],
    ...
    "identity:delete_policy_association_for_service": {
        ...
        "operations": [
            "DELETE /v3/policies/{policy_id}/OS-ENDPOINT-POLICY/services/"
            "{service_id}"
        ],
    ...
    "identity:create_policy_association_for_region_and_service": {
        ...
        "description": "Associate a policy to a specific"
        " region and service combination."
    },
    ...
    "identity:update_project_tags": {
        ...
        " project with the new set of tags."
    },
    ...
    "identity:check_endpoint_in_project": {
        ...
        "operations": [
            "GET /v3/OS-EP-FILTER/projects/"
            "{project_id}/endpoints/{endpoint_id}",
            "HEAD /v3/OS-EP-FILTER/projects/"
            "{project_id}/endpoints/{endpoint_id}"
        ],
    ...
    "identity:remove_endpoint_from_project": {
        ...
        "operations": [
            "DELETE /v3/OS-EP-FILTER/projects/"
            "{project_id}/endpoints/{endpoint_id}"
        ],
        "description": "Remove access to an endpoint from a project"
        " that has previously been given explicit access."
    },
    "identity:create_protocol": {
        ...
        "operations": [
            "PUT /v3/OS-FEDERATION/identity_providers/"
    ...
    "identity:update_protocol": {
        ...
        "operations": [
            "PATCH /v3/OS-FEDERATION/identity_providers/"
            "{idp_id}/protocols/{protocol_id}"
        ],
    ...
    "identity:delete_protocol": {
        ...
        "operations": [
            "DELETE /v3/OS-FEDERATION/identity_providers/"
            "{idp_id}/protocols/{protocol_id}"
        ],
    ...
    "identity:list_role_assignments_for_tree": {
        ...
        "description": "List all role assignments for"
        " a given tree of hierarchical projects."
    },
    ...
    "identity:update_user": {
        ...
        " including administrative password resets."
    },
