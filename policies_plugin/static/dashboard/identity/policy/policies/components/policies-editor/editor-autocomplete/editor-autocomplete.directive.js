...
(function() {
    ...
    angular
        ...
        .directive('editorAutocomplete', editorAutocomplete);

    editorAutocomplete.$inject = [
        'autocompleteConfig',
        '$timeout',
        '$window',
        '$document',
    ...
    function editorAutocomplete(config, $timeout, $window, $document, $q) {
        return {
            restrict: 'A',
            scope: { options: '&editorAutocomplete' },
            transclude: true,
            template:
