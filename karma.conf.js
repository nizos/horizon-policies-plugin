...
module.exports = function (config) {
    ...
    config.set({
        ...
        files: [
            ...
            './policies_plugin/static/dashboard/identity/policy/actions/filter/filter.module.js',
            ...
            './policies_plugin/static/dashboard/identity/policy/actions/sort/sort.module.js',
            './policies_plugin/static/dashboard/identity/policy/actions/storage/storage.module.js',
            ...
            './policies_plugin/static/dashboard/identity/policy/policies/components/confirm-dialog/confirm-dialog.module.js',
            ...
            './policies_plugin/static/dashboard/identity/policy/actions/filter/filter.provider.js',
            ...
            './policies_plugin/static/dashboard/identity/policy/actions/sort/sort.provider.js',
            './policies_plugin/static/dashboard/identity/policy/actions/storage/storage.provider.js',
            ...
            './policies_plugin/static/dashboard/identity/policy/policies/components/confirm-dialog/confirm-dialog.controller.js',
            ...
            './policies_plugin/static/dashboard/identity/policy/policy.module.spec.js',
            './policies_plugin/static/dashboard/identity/policy/actions/actions.module.spec.js',
            './policies_plugin/static/dashboard/identity/policy/api/api.module.spec.js',
            './policies_plugin/static/dashboard/identity/policy/model/model.module.spec.js',
            './policies_plugin/static/dashboard/identity/policy/policies/policies.module.spec.js',
            './policies_plugin/static/dashboard/identity/policy/policies/components/components.module.spec.js',
            './policies_plugin/static/dashboard/identity/policy/svg-icons/svg-icons.module.spec.js',
            // './static/**/*.spec.js',
